<script lang="ts">
    ...
    let attachClickHandlerInterval: number | undefined
    onMount(() => {
        const gapiJsScript = document.createElement("script")
        gapiJsScript.src = "https://apis.google.com/js/platform.js"
    ...
    onDestroy(() => {
        clearInterval(initInterval)
        clearInterval(attachClickHandlerInterval)
    })
    ...
    function attachClickHandler() {
        ...
        GoogleAuth!.attachClickHandler(
            container,
            {},
            (googleUser) => dispatch("success", { googleUser }),
