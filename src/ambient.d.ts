...
declare module "fakerator" {
    ...
    export class fakerator {
        ...
        times(
            functionWillRepeat: Function,
            nTimes: number,
            ...args: Array<any>
        ): Array<any>
        times(
            functionWillRepeat: Function,
            options: ITimesOptions,
            ...args: Array<any>
        ): Array<any>
        ...
        generate(
            functionWillBeUsedForGeneration: Function,
            ...args: Array<any>
        ): string
