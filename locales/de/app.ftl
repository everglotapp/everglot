...
chat-sidebar-controls-games = Spiele
...
chat-side-panel-bubble-no-activity-available = Sorry, Everglot unterstützt für { $language } noch keine Spiele.
...
chat-side-panel-activity-quit-text = Du beendest damit das Spiel für alle in der Gruppe, bist Du sicher?
chat-side-panel-activity-quit-cancel = Abbrechen
chat-side-panel-activity-quit-confirm = Ja, Spiel beenden
...
chat-side-panel-activity-would-you-rather-next-question = Eine weitere Frage stellen
chat-side-panel-activity-random-question-next-question = Eine weitere Frage stellen
chat-side-panel-activity-random-question-discuss = Diskutiert in der Gruppe.
...
chat-activity-text-input = { "" }
    .placeholder = Gib deinen Tipp ab …
chat-submit-form-voice = Audio
chat-submit-form-voice-join-call = Anruf beitreten
chat-submit-form-voice-leave-call = Anruf verlassen
chat-submit-form-voice-switch-call = Anruf wechseln
chat-submit-form-voice-mute = Stummschalten
chat-submit-form-voice-unmute = Mikro anschalten
...
u-username-section-bio-edit-cancel = abbrechen
u-username-section-bio-edit-form-cancel = Abbrechen
u-username-section-bio-edit-form-save = Speichern
u-username-section-bio-empty = Wir warten alle gespannt darauf, dass { $username } sich vorstellt.
u-username-followers-none = Niemand folgt { $username } bisher ☹️
