...
exports.up = (pgm) => {
    ...
    pgm.sql(`GRANT SELECT ON app_public.random_questions_it TO evg_server`)
}

exports.down = (pgm) => {
    pgm.sql(`REVOKE SELECT ON app_public.random_questions_it FROM evg_server`)
    pgm.dropPolicy(
        { schema: "app_public", name: "random_questions_it" },
        "select_server",
        {
    ...
    pgm.dropTable({ schema: "app_public", name: "random_questions_it" })
}