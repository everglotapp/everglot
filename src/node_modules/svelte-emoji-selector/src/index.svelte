<script>
  ...
  export let recentEmojisCacheKey = 'svelte-emoji-picker-recent'
  ...
  let currentEmoji;
  let searchText;
  let recentEmojis = JSON.parse(localStorage.getItem(recentEmojisCacheKey)) || [];
...
<button class="svelte-emoji-picker__trigger" type="button" bind:this={triggerButtonEl} on:click={togglePicker}>
  <Icon icon={smileIcon} />
</button>
