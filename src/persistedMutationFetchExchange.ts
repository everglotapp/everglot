 ...
 * https://github.com/FormidableLabs/urql/blob/77fe7725d039f89500f03560aea19254630d8a5f/exchanges/persisted-fetch/src/persistedFetchExchange.ts
 *
 * @urql/svelte does not support persisted operations for mutations and
 * subscriptions, only for queries. So we revert their filtering here and only
 * hash non-query operations here.
 */
...
export const persistedMutationFetchExchange = (
    ...
    const hashFn = options.generateHash
