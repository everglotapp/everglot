...
exports.up = (pgm) => {
    ...
    pgm.sql(`GRANT SELECT ON app_public.words_de TO evg_server`)
}

exports.down = (pgm) => {
    pgm.sql(`REVOKE SELECT ON app_public.words_de FROM evg_server`)
    pgm.dropPolicy(
        { schema: "app_public", name: "words_de" },
        "select_server",
        {
    ...
    pgm.dropTable({ schema: "app_public", name: "words_de" })
}
